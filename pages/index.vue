<template>
  <main class="overflow-x-hidden w-full max-w-full bg-[#09090b]">
    ...
    <HeroSection
      title="让你的锁车声，与众不同"
      overline="NIO L60 · 2026 Edition · <span style='display:inline-flex;align-items:center;padding:2px 10px;border-radius:100px;background:rgba(233,69,96,0.1);border:1px solid rgba(233,69,96,0.25);box-shadow:0 0 20px rgba(233,69,96,0.08)'><span style='background:linear-gradient(135deg,#e94560,#ff8aae);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;font-weight:700'>川A·BQ0326</span></span> 求偶遇，滴滴即友"
