  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'preload', href: 'https://fonts.googleapis.com/css2?family=ZCOOL+KuaiLe&family=Noto+Sans+SC:wght@400;500;700;900&family=Plus+Jakarta+Sans:wght@400;600;700;800&display=swap', as: 'style' },
